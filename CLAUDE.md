...
- `.claude/skills/simple-spec/SKILL.md` — the `/simple-spec` skill, and the only file that ships. Applies `RULES.md` to a document, a section, or a git diff. The rules and worked example are embedded into `SKILL.md`, so it is self-contained.
